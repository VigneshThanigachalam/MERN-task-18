...
function fetch_weather(country, card_number) {
    ...
    fetch(
        `https://api.openweathermap.org/data/2.5/weather?q=${country}&APPID=69f4aafc5eec73e45327babebaab487a`
    )
        .then((response) => response.json())
        .then((data) => {
            document.getElementById("weather_data_" + card_number).innerHTML =
